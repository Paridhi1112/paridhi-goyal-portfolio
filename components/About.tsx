...
export default function About() {
  ...
  return (
    <section id="about" className="py-28 md:py-36 bg-[var(--color-bg)] relative overflow-hidden" ref={ref}>
      {/* Ambient background light */}
      <div className="absolute top-1/4 left-0 w-96 h-96 bg-[#00FFA3]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start mb-20">
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-3 pt-4">
              {[
                ...
                <motion.span
                  ...
                  className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] text-xs font-mono text-[var(--color-subtle)] shadow-sm hover:border-[#00FFA3]/40 transition-colors"
                >
          ...
          >
            <TiltCard glowColor="#00FFA3" tiltMaxAngleX={12} tiltMaxAngleY={12} scaleOnHover={1.02}>
              <div className="glass rounded-2xl p-6 border border-[var(--color-border)] bg-[var(--color-surface)]/80 backdrop-blur-xl shadow-2xl">
                ...
                {[
                  ...
                  <div key={row.layer} className="flex items-start gap-3 py-3 border-b border-[var(--color-border)] last:border-0 group/item">
                    <div
                      className="mt-1 w-1 h-12 rounded-full flex-shrink-0 opacity-70 group-hover/item:scale-y-110 transition-transform"
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium text-[var(--color-text)] font-sans">
                        {row.value}
                      </div>
                    </div>
                    <div
              ...
              return (
                <motion.div key={item.title} variants={fadeUp}>
                  <TiltCard glowColor="#00FFA3" tiltMaxAngleX={10} tiltMaxAngleY={10} scaleOnHover={1.03} className="h-full">
                    <div className="glass rounded-2xl p-6 border border-[var(--color-border)] h-full bg-[var(--color-surface)]/80 backdrop-blur-xl group">
                      <div className="w-11 h-11 rounded-xl bg-[#00FFA3]/15 border border-[#00FFA3]/30 flex items-center justify-center mb-4 text-[#00FFA3] shadow-md group-hover:scale-110 transition-transform">
                        <Icon className="w-5 h-5" />
                      </div>
                      <h4 className="font-display font-bold text-[var(--color-text)] text-lg mb-2 group-hover:text-[#00FFA3] transition-colors">
                        {item.title}
                      </h4>
